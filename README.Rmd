...
may usually do in GitHub actions. It is most useful to test locally the `HEAD`
of the working directory in the context of the master branch of one or multiple
other repositories.
